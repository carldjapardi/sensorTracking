...
import com.example.sensortracking.data.PDRDataPoint
import com.example.sensortracking.data.PDRDataSeries
...
import com.example.sensortracking.data.SessionMetadata
import com.example.sensortracking.data.StepDataSeries
...
class SensorDataLogger {
    ...
    private fun generatePathBitmap(pathHistory: List<Position>, area: Area, warehouseMap: WarehouseMap?, width: Int = 400, height: Int = 400): Bitmap {
    ...
    fun getCurrentSession(sessionName: String, area: Area, warehouseMap: WarehouseMap?, pdrConfig: PDRConfig, pathHistory: List<Position>, pathSegments: List<PathSegment>): TrackingSession {
